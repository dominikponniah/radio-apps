...
package ch.dominikponniah.mediaplayer.regenbogen
...
import ch.dominikponniah.mediaplayer.regenbogen.fragments.MediaItemFragment
...
import ch.dominikponniah.mediaplayer.regenbogen.utils.InjectorUtils
import ch.dominikponniah.mediaplayer.regenbogen.viewmodels.MainActivityViewModel
...
if(disclaimerShowed === "showed") {
      ...
      builder.setNeutralButton("Webplayer öffnen") { dialog, which ->
        ...
        val webpage: Uri = Uri.parse("https://regenbogen.de")
