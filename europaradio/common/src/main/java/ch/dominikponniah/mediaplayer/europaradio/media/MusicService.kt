...
package ch.dominikponniah.mediaplayer.europaradio.media
...
import ch.dominikponniah.mediaplayer.europaradio.media.extensions.album
import ch.dominikponniah.mediaplayer.europaradio.media.extensions.flag
import ch.dominikponniah.mediaplayer.europaradio.media.extensions.id
import ch.dominikponniah.mediaplayer.europaradio.media.extensions.toMediaQueueItem
import ch.dominikponniah.mediaplayer.europaradio.media.extensions.toMediaSource
import ch.dominikponniah.mediaplayer.europaradio.media.extensions.trackNumber
import ch.dominikponniah.mediaplayer.europaradio.media.library.AbstractMusicSource
import ch.dominikponniah.mediaplayer.europaradio.media.library.BrowseTree
import ch.dominikponniah.mediaplayer.europaradio.media.library.JsonSource
import ch.dominikponniah.mediaplayer.europaradio.media.library.MEDIA_SEARCH_SUPPORTED
import ch.dominikponniah.mediaplayer.europaradio.media.library.MusicSource
import ch.dominikponniah.mediaplayer.europaradio.media.library.UAMP_BROWSABLE_ROOT
import ch.dominikponniah.mediaplayer.europaradio.media.library.UAMP_EMPTY_ROOT
import ch.dominikponniah.mediaplayer.europaradio.media.library.UAMP_RECENT_ROOT
import ch.dominikponniah.mediaplayer.europaradio.media.R
...
open class MusicService : MediaBrowserServiceCompat() {
    ...
    private val dataSourceFactory: DefaultDataSourceFactory by lazy {
        DefaultDataSourceFactory(
            /* context= */ this,
            Util.getUserAgent(/* context= */ this,
                UAMP_USER_AGENT
            ), /* listener= */
            null
        )
    ...
    private val remoteJsonSource: Uri =
        Uri.parse("https://raw.githubusercontent.com/dominikponniah/radio-apps/main/api/europa-radio.json")
    ...
    override fun onCreate() {
        ...
        mediaSource =
            JsonSource(source = remoteJsonSource)
        serviceScope.launch {
            mediaSource.load()
        }
 ...
 */
const val NETWORK_FAILURE = "ch.dominikponniah.mediaplayer.europaradio.media.session.NETWORK_FAILURE"
